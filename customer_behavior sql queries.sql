...
select "Discount Applied" from customer;

--01Total revenue generated by male vs female customers
select "Gender", sum("Purchase Amount (USD)") as revenue 
from customer
group by "Gender"

--02which customers used a discount but still spent more than the average purchase amount
...
--03which are the top 5 products with the highest average review rating
